...
const TOOLS = [
  {
    ...
    description: "Answer a few questions to check your child's eye risk",
    longDescription: "Fill in simple details about age, family history, and daily habits. The app gives an easy-to-read result showing whether your child may need closer eye care.",
  ...
  },
  {
    ...
    description: "Upload an eye photo to get an AI-based check",
    longDescription: "Add a clear retinal image and the app will look for signs that may point to myopia. It is best used with good-quality eye photos.",
  ...
  },
  {
    ...
    description: "See how vision may change over time",
    longDescription: "Estimate how a child's eyesight may change in the future and compare what happens with or without treatment.",
  ...
  },
  {
    ...
    description: "Track how the eye may grow over time",
    longDescription: "Shows whether the eye may grow faster than normal and helps compare the effect of treatment.",
    icon: <Ruler className="h-6 w-6" />, href: "/axial",
    color: "#B45309", bgColor: "rgba(180,83,9,0.08)",
  },
  {
    id: "onset", title: "Onset Predictor",
    description: "Estimate when myopia may start",
    longDescription: "Helps you understand if myopia may start soon based on the child's age and eye measurements.",
